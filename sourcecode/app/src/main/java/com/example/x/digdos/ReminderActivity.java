...
/*public class ReminderActivity extends Activity
{
    ...
    private void updateReminderSpinnerContent()
    {
        ...
        else if(modeEdit())
        {
            ...
            //Runs while there is a next row to move to in CR (runs once even if the amount of rows is 1, since Cursor starts at 0, before any actual rows),
            while(CR.moveToNext())
            {
                //Creates objects of the classes that were initially saved as Strings to the database with Gson.
                ActivationData initialActivation = gson.fromJson(CR.getString(4), ActivationData.class);
                ...
                ActivationData latestActivation = gson.fromJson(CR.getString(8), ActivationData.class);
...
public class ReminderActivity extends Activity
{
    ...
    private void updateReminderSpinnerContent()
    {
        ...
        else if(modeEdit())
        {
            ...
            //Metodens kod till denna punkt är irrelevant för användningen av Gson.

            //Skapar objekt av Gson.
            Gson gson = new Gson();

            //Loop som kör så länge det finns en ny rad av data kvar i en Cursor med namnet CR.
            //En rad data från CR innehåller information om en av databasens påminnelser i
            // JSON format.
            while(CR.moveToNext())
            {
                //Här används fromJson() för att konvertera data från teckensträngar till olika
                // klassrepresentationer inom programmet.
                //Märk att imageData, soundData och repeatData redan är deklarerade tidigare, medan
                // getString() returnerar en teckensträng från en rads olika kolumner i CR.
                ...
                //Resten av metoden är irrelevant för användningen av Gson.
    ...
    //Aktiveras då användaren trycker på addImageButton.
    //Öppnar en ny vy där användaren kan hantera bilder och koppla dem ihop med en påminnelse.
    public void addImageButton(View view)
    {
        //Skapar objekt av Intent.
        //Har att göra med nya vyn, inte Gson.
        Intent addImageIntent = new Intent(this, AddImage.class);

        //Skapar objekt av Gson.
        Gson gson = new Gson();

        //Använder toJson() för att konvertera klassdata/objektdata till en teckensträng med
        // JSON format.
        //Märk att imageData är deklarerad tidigare och är objekt av ImageData.
        String imageDataString = gson.toJson(imageData);

        //Fäster teckensträngen som representerar ImageData till addImageIntent.
        //Används så att vyn som startas (AddImage) är medveten om påminnelsens ImageData.
        //Har inget att göra med Gson.
        addImageIntent.putExtra("imageDataInitial", imageDataString);

        //Öppnar den nya vyn addImageIntent är kopplad till.
        //Har inget att göra med Gson.
        startActivityForResult(addImageIntent, GV.ADD_IMAGE_REQUEST_CODE);
    }
